...
// Definición de la función coseno usando un ciclo while
const calcularCoseno = (x, terminos) => {
...
rl.question("Este programa calcula el coseno utilizando una serie de Taylor.\nIngrese el número de términos de la serie: ", (terminos) => {
  rl.question("Ingrese el valor de x: ", (x) => {
    const resultado = calcularCoseno(x, terminos); // Llamada a la función calcularCoseno con los parámetros proporcionados por el usuario
